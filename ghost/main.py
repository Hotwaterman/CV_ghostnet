...
from resnet2 import *
from ghostnet1 import *
from ghostresnet import *
import argparse
...
parser.add_argument('--logdir', type=str, default='logs3', help='')
...
def test(epoch, best_acc, global_steps):
	...
	if acc > best_acc:
		...
		if not os.path.isdir('save_model'):
		    os.mkdir('save_model')
		torch.save(state, './save_model/ckpt5.pth')
		best_acc = acc
...
if __name__=='__main__':
	...
	if args.resume is not None:
		test(epoch=0, best_acc=0, global_steps)
	else:
		while True:
			epoch += 1
